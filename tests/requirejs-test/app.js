...
//       'd3by5-base-chart': 'lib/d3by5-base-chart',
//       'd3by5-axis': 'lib/d3by5-axis',
...
//         },
//         'bar-chart': {
//           deps: ['underscore', 'd3', 'd3by5-base-chart', 'barOptions', 'barDimensions', 'barPositions', 'labelOptions']
//         },
...
requirejs.config({
    paths: {
        'bar-chart': '../../src/bar-chart',
        'd3': 'lib/d3',
        'underscore': 'lib/underscore-1.8.3',
        'bar-chart-options': '../../src/bar-chart-options',
        'bar-chart-label-options': '../../src/bar-chart-label-options',
        'bar-chart-positions': '../../src/bar-chart-positions',
        'bar-chart-dimensions': '../../src/bar-chart-dimensions',
        'base-chart': '../../src/base-chart',
        'base-chart-utils': '../../src/base-chart-utils',
        'base-chart-axis': '../../src/base-chart-axis',
        'bar-chart-axis': '../../src/bar-chart-axis',
...
require(['bar-chart','underscore','d3'], function (bargraph, _, d3) {
  'use strict';
